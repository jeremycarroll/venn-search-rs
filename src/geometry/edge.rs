...
//! MEMO (immutable, precomputed) edge data for Venn diagrams.
//!
//! This module contains EdgeMemo and related reference types:
...
//!
//! For the DYNAMIC (mutable, trail-tracked) edge data, see [`crate::state::DynamicEdge`].
//!
...
/// Supported historical name for [`crate::state::DynamicEdge`].
///
