...
> **Note**: This document describes the **C implementation** test suite from the reference implementation.
> For the **Rust implementation** test suite, see [TESTS.md](TESTS.md).
>
> This documentation is preserved as a reference for:
> - Understanding the mathematical concepts behind tests
> - Visual diagrams that apply to both C and Rust implementations
> - Identifying test coverage gaps during the migration

This document describes the C test suite and includes illustrations for tests that benefit from visual representation.
